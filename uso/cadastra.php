...
<body   >
	...
	<nav class="navbar navbar-light bg-light">
		  <button><a class="navbar-brand text-danger" href="consulta.php">Consultar um Produto</a>
		  	</button>
		  ...
		  <button><a class="navbar-brand text-danger" href="../index.php">Sair</a></button>
				...
				<p style="margin-left:15px">
					...
					<p style="margin-left:15px">
					 Após Clicar em cadastrar os dados do formulario serão iseridos no Banco de dados e estarão disponiveis para consulta  <strong><a href="consulta.php"> clicando aqui.</a></strong>
				</p>
			</div>
	...
	<br><hr>
			...
			<!--<div style="width:800px; height:150px ; overflow-y: scroll; ">
				...
				//	$resultado_func = mysqli_query($conn,$busca) or die("Erro ao retornar dados");

					
			   		// while($dado_func =mysqli_fetch_array($resultado_func)) {
				   //		$id=$dado_func['Id'];

			   		 //	$n_funcionario=$dado_func['NomeFuncionario'];
				   	//	$funcao=$dado_func['Cargo'];
				...
				Nome do Funcionário:</label>
					<input id="input-produto-nome" name="nome-funcionario" type="text" required="" class="form-control" /><?php //echo " $id - $n_funcionario - $funcao";  ?>
				</div>

				<!--<input id="input-produto-nome" name="nome-funcionario" type="checkbox" required="" class="form-control" /><?php// echo " $id - $n_funcionario - $funcao";  ?>
				</div>
				<input id="input-produto-nome" name="nome-funcionario" type="checkbox" required="" class="form-control" /><?php// echo " $id - $n_funcionario - $funcao";  ?>
				</div>
				<?php 
			//}
				 ...
				 ?>
				Teste Para lista de funcionarios nos BD</div>-->
